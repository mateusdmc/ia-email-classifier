...
// ==========================================
// ATUALIZA INTERFACE DIAGNOSTICO
// ==========================================
...
// ==========================================
// EDITA, SALVA E CÓPIA DIAGNOSTICO
// ==========================================
function toggleEdit() {
...
function handleInputValidation() {
    ...
    if (textarea.value.trim().length > 0) {
        ...
        fileLabel.classList.remove('cursor-pointer');
        ...
        fileLabel.classList.add('cursor-pointer');
